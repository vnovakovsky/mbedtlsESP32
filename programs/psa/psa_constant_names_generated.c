...
{
    switch (curve) {
    case PSA_ECC_CURVE_BRAINPOOL_P_R1: return "PSA_ECC_CURVE_BRAINPOOL_P_R1";
    case PSA_ECC_CURVE_MONTGOMERY: return "PSA_ECC_CURVE_MONTGOMERY";
    case PSA_ECC_CURVE_SECP_K1: return "PSA_ECC_CURVE_SECP_K1";
    case PSA_ECC_CURVE_SECP_R1: return "PSA_ECC_CURVE_SECP_R1";
    case PSA_ECC_CURVE_SECP_R2: return "PSA_ECC_CURVE_SECP_R2";
    case PSA_ECC_CURVE_SECT_K1: return "PSA_ECC_CURVE_SECT_K1";
    case PSA_ECC_CURVE_SECT_R1: return "PSA_ECC_CURVE_SECT_R1";
    case PSA_ECC_CURVE_SECT_R2: return "PSA_ECC_CURVE_SECT_R2";
    default: return NULL;
    }
}
...
{
    switch (group) {
    case PSA_DH_GROUP_CUSTOM: return "PSA_DH_GROUP_CUSTOM";
    case PSA_DH_GROUP_RFC7919: return "PSA_DH_GROUP_RFC7919";
    default: return NULL;
    }
}
